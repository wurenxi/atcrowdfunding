...
public class CrowdAccessFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        ...
        // 2.通过RequestContext对象获取当前请求对象(框架底层是借助ThreadLocal从当前线程上获取事先绑定的的Request对象)
        ...
        if(containsResult){
            // 5.如果当前请求是可以直接放行的特定功能请求则返回false方向
            return false;
        }
    ...
    public Object run() throws ZuulException {
        ...
        // 4.判断loginMember是否为空
        if(loginMember == null){
            // 5.从requestContext对象获取Response对象
