...
@Configuration
@EnableWebSecurity
// 启用全局方法权限控制功能，并且设置prePostEnabled = true，保证@PreAuthority、@PostAuthority、@PostFilter生效
...
//                .hasRole("经理")  // 要求具备“经理”角色
                ...
                .defaultSuccessUrl("/admin/to/main/page.html",true)  // 指定登录成功后前往的页面
                .usernameParameter("loginAcct") // 帐号的请求参数名称
