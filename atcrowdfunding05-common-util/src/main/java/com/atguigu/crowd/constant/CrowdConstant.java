 ...
 * @description:
 * @author: gxl
 * @createDate: 2021/10/25 20:15
 */
public class CrowdConstant {
    public static final String MESSAGE_LOGIN_FAILED = "抱歉，帐号密码错误。请重新输入！";
    ...
    public static final String MESSAGE_SYSTEM_ERROR_LOGIN_NOT_UNIQUE = "登录帐号不唯一";
    public static final String MESSAGE_CODE_NOT_EXISTS = "验证码已过期！请检查手机是否正确或重新发送！";
    ...
    public static final String MESSAGE_TEMP_PROJECT_MISSION = "临时存储的Project对象丢失！";
